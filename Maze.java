...
public class Maze extends JPanel{
    ...
    */
            ...
            switch (dir) {
                ...
                case 'D':
                    ...
                    for (int i = 0; i < mag; i++) {
                        ...
                        tmp.set_state(Cell.CELL_USER_SEARCHED);
                    }
                    break;
                case 'U':
                    //loop through all the cells from y to y - mag
    ...
    public void prims_frame(StatMaker statMaker, ArrayList<Pair> cells)
    {
        //random number generator
        Random rand = new Random();
        ...
        if (!cells.isEmpty()) {
            ...
            Cell curr = matrix.get(index);
            Cell prev = matrix.get(prev_index);
    ...
    {
        //set the name of the generation algorithm to 'prims'
