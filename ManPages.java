...
public class ManPages extends JFrame
{
    ...
    //reference to edit the window manPageOpen button
    private JButton manPageOpen;
    
    //ManPages constructor
    public ManPages(String title, int w, int h, JButton manPageOpen) 
    {
        ...
        //page total, used to create circular buffer
        page_total = 3;
        
        //set the text for the page label, centering the text
        page_no_label = new JLabel(String.valueOf(page_no+1) + "/" +
                String.valueOf(page_total), SwingConstants.CENTER);
        ...
        generate_maze_desc = new JLabel("<html>The 'Generate Maze' button is "
                + "used to generate a maze within the maze area."
                + " This uses Depth First Search and Prim's algorithm.</html>");
        
        solve_maze_desc = new JLabel("<html>The 'Solve Maze' button is used"
                + " to solve the current maze within the maze area."
                + " This uses Breadth First Search and the Recursive Algorithm"
                + "</html>");
        ...
        validate_soln_desc = new JLabel("<html>The 'Validate Solution' button "
                ...
                + " area can be found on page 3.</html>");
        ...
        load_maze_desc = new JLabel("<html>The 'Load Maze' button is used to "
                ...
                + " on this button can be seen on page 2.</html>");
        ...
        //window event handler to report when the manual window is closed
        this.addWindowListener(new WindowAdapter() 
        {
            //override of windowClosing default event
            public void windowClosing(WindowEvent e)
            {
                //enable the 'manPageOpen' button when the manual is closed
                ManPages.this.manPageOpen.setEnabled(true);
            }
        });
        ...
        user_soln_desc = new JLabel("<html>This is the text area "
                ...
                + " be from 0-99, the direction must be capitalised. <br><br>"
    ...
    public void move_left()
    {
        ...
        page_no_label.setText(String.valueOf(page_no+1) + "/" + 
                String.valueOf(page_total));
