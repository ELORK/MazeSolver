    ...
    */
    public Window(String title, int w, int h)
    {
        ...
        */
        ...
        selectSolveCombo.addItem("Breadth First Search");
        selectSolveCombo.addItem("Recursive");
        
        selectMazeCombo.addItem("Depth First Search");
        selectMazeCombo.addItem("Prim's Algorithm");
    ...
    public void solve()
    {
        ...
        if (solve_str == "Breadth First Search") {
    ...
    public void generate()
    {
        ...
        if (maze_str == "Depth First Search") { 
        ...
        } else if (maze_str == "Prim's Algorithm") {
            //if the button is currently pressed
            if (toggleSpeed.isSelected()) {
                ...
                statMaker.stat_generate = "Prim's Algorithm";
                //set all the cells in the maze to walls
                for (int i = 0; i < maze.matrix.size(); i++) {
                    Cell curr = maze.matrix.get(i);
                    curr.set_state(Cell.CELL_WALL);
